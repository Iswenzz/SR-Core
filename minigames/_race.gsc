...
main()
{
	...
	sr\core\_minigames::createMinigame("race");
...
onSpawn()
{
	...
	if (!sr\core\_minigames::isInQueue("race"))
		return;
...
leave()
{
	self sr\core\_minigames::removeFromQueue("race");
	self cleanRaceHud();
	self unlink();
...
onDeath()
{
	if (!self sr\core\_minigames::isInQueue("race") || !level.raceStarted)
		return;
