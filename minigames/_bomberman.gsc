...
main()
{
	sr\core\_minigames::createMinigame("bomberman");
...
onSpawn()
{
	...
	if (!sr\core\_minigames::isInQueue("bomberman"))
		return;
...
join()
{
	self sr\core\_minigames::addToQueue("bomberman");
...
leave()
{
	...
	self sr\core\_minigames::removeFromQueue("bomberman");
...
spawnPlayerInRoom(spawnIndex)
{
	...
	self sr\core\_minigames::minigameSpawn(level.bombermanSpawns[spawnIndex]);
