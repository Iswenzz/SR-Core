...
start()
{
	...
	thread showCredit("SR Mod 2017-2026", 2, 40, 17.5, 0);
	thread showCredit("Iswenzz", 1.8, 80, 17, 2);
	...
	thread showCredit("Anomaly   Vc' Blade   n1kjs   Mist", 1.6, 260, 15.5, 4.5);
	thread showCredit("kLeiN   stu   Death   NitroFire   hehexd", 1.6, 300, 15.5, 4.5);
...
fade(duration, startTime)
{
	...
	self thread fadeIn(0, 1, "right", 2);
	wait duration - startTime;
	self thread fadeOut(0, 1, "right", 2);
}
