...
gsclib()
{
	...
	sr\libs\gsclib\__test__\_test_game::main();
	sr\libs\gsclib\__test__\_test_io::main();
	sr\libs\gsclib\__test__\_test_network::main();
	sr\libs\gsclib\__test__\_test_system::main();
