...
#define NAV_MENU_FULLSCREEN_RECT                RECT_MENU_CENTER_W_TOP_H(0, (MAINNAV_HEIGHT + MAINNAV_SEPARATOR_HEIGHT + SUBNAV_HEIGHT), 640, 480)
#define NAV_MENU_FULLSCREEN_RECT_SERVERBROWSER  RECT_MENU_CENTER_W_TOP_H(0, (MAINNAV_HEIGHT + MAINNAV_SEPARATOR_HEIGHT + SUBNAV_HEIGHT), 820, 480)
